...
{
    /// <summary>
    /// Summary description for getDetailNotQAValSMT
    /// </summary>
    public class getDetailNotQAValSMT : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                html += "<div id='tableDetSMT'><table id='tableDetQANonValSMT' class='table display nowrap' style='font-size:11px;width:93%;'>";
